...
function! configure#vim_log#hook_post_source()
  augroup VimLogEsp32
    au!
    au Syntax log syn match logLevelDetailConceal /^.*\(\%x1b\[0m\)\?\r$/ contains=concealAnsiColorStart,concealAnsiResetConceal,logString,logNumber keepend
    ...
    au Syntax log setlocal conceallevel=2 concealcursor=n
  augroup END
endfunction
