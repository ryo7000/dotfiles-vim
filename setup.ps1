...
# vim
Invoke-WebRequest -Uri "https://github.com/koron/vim-kaoriya/releases/download/v8.1.1010-20190317/vim81-kaoriya-win64-8.1.1010-20190317.zip" -OutFile vim.zip
